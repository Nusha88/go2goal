...
/* harmony import */ var _services_user_form_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./services/user-form.service */ "./src/app/services/user-form.service.ts");
...
/* harmony import */ var _goals_goal_of_life_first_level_step_first_level_step_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./goals/goal-of-life/first-level-step/first-level-step.component */ "./src/app/goals/goal-of-life/first-level-step/first-level-step.component.ts");
...
/* harmony import */ var _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! @angular/cdk/overlay */ "./node_modules/@angular/cdk/esm5/overlay.es5.js");
...
/* harmony import */ var _pipes_truncate_pipe__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./pipes/truncate-pipe */ "./src/app/pipes/truncate-pipe.ts");
/* harmony import */ var _reviews_reviews_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./reviews/reviews.component */ "./src/app/reviews/reviews.component.ts");
/* harmony import */ var _contact_contact_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./contact/contact.component */ "./src/app/contact/contact.component.ts");
/* harmony import */ var _forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./forgot-password/forgot-password.component */ "./src/app/forgot-password/forgot-password.component.ts");
/* harmony import */ var _reset_password_reset_password_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./reset-password/reset-password.component */ "./src/app/reset-password/reset-password.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _goals_goal_of_life_first_level_step_first_level_step_component__WEBPACK_IMPORTED_MODULE_28__["FirstLevelStepComponent"],
                _main_page_main_page_component__WEBPACK_IMPORTED_MODULE_29__["MainPageComponent"],
                _pipes_truncate_pipe__WEBPACK_IMPORTED_MODULE_36__["TruncatePipe"],
                _reviews_reviews_component__WEBPACK_IMPORTED_MODULE_37__["ReviewsComponent"],
                _contact_contact_component__WEBPACK_IMPORTED_MODULE_38__["ContactComponent"],
                _forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_39__["ForgotPasswordComponent"],
                _reset_password_reset_password_component__WEBPACK_IMPORTED_MODULE_40__["ResetPasswordComponent"],
            ],
            imports: [
                _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_35__["NgbModule"].forRoot(),
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                ng2_search_filter__WEBPACK_IMPORTED_MODULE_3__["Ng2SearchPipeModule"],
                _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_2__["BrowserAnimationsModule"],
                _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_11__["FormsModule"],
                _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_34__["OverlayModule"],
            ...
            providers: [
                ...
                // TodoDataService,
                _angular_material__WEBPACK_IMPORTED_MODULE_30__["MatDialog"],
                _services_user_form_service__WEBPACK_IMPORTED_MODULE_26__["UserFormService"]
            ],
...
module.exports = "\n<nav class=\"navbar navbar-expand-lg\">\n  <a class=\"navbar-brand\" routerLink=\"/\">\n    <img src=\"../../assets/images/logoShot.png\" alt=\"\">\n  </a>\n  <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarSupportedContent\" aria-controls=\"navbarSupportedContent\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n    <span> <i class=\"ion-navicon-round\"></i></span>\n  </button>\n\n  <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">\n    <ul class=\"navbar-nav mr-auto\">\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLinkActive=\"active\" [routerLink]=\"'/goals'\"><i class=\"ion-trophy\"></i> Goals</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLinkActive=\"active\" [routerLink]=\"'/todos'\" ><i class=\"ion-android-checkbox-outline\"></i> Todos</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLinkActive=\"active\" [routerLink]=\"'/notes'\"><i class=\"ion-compose\"></i> Notes</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLinkActive=\"active\" [routerLink]=\"'/posts'\"><i class=\"ion-ios-paper-outline\"></i> Posts</a>\n      </li>\n    </ul>\n    <form class=\"form-inline\">\n      <p><a [routerLink]=\"'/profile'\"  class=\"user-link\">{{username}}</a></p>\n      <button class=\"btn btn--transparent\" (click)=\"logout()\">Log out</button>\n    </form>\n  </div>\n</nav>\n"
...
module.exports = "<div class=\"notebook-page__component\">\n  <div class=\"content\">\n    <div class=\"jumbotron jumbotron-fluid\">\n      <div class=\"container text-center\">\n        <div class=\"row\">\n          <h2 class=\"heading-secondary text-center\">Notes</h2>\n          <p class=\"notebook__header--paragraph\">\"People with goals succeed because they know where they're going\".\n          </p>\n          <p class=\"author\">Earl Nightingale</p>\n        </div>\n      </div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col-md-12 notebook-content\">\n        <p class=\"notebook--paragraph\">Leave here any notes, your favorite quotes and expressions, useful resources,\n          links. Everything you don't want to forget or lose.</p>\n        <div class=\"row\">\n          <div class=\"col-md-12\">\n            <div class=\"notebook-content__area\">\n              <form [formGroup]=\"addNoteForm\">\n                <textarea #note name=\"note\" id=\"note\" placeholder=\"Enter Note Here...\"\n                          formControlName=\"note\"></textarea>\n              </form>\n              <button [disabled]=\"!addNoteForm.valid\" type=\"submit\" (click)=\"addNote(note.value)\"><i\n                class=\"ion-android-add add-todolist-icon\"></i></button>\n            </div>\n            <div class=\"notebook-content__area note-content\" *ngFor=\"let note of notes; let index = index\">\n              <span (click)=\"editNote(note)\" class=\"todo--edit\"><i class=\"ion-edit\"></i></span>\n              <span (click)=\"deleteNote(note, index)\" class=\"delete-icon\"><i class=\"ion-close-round\"></i></span>\n              <p>{{note.title}}</p>\n              <div class=\"form-group edit-note-form\" *ngIf=\"note.isEdited\">\n              <textarea type=\"text\"\n                        #noteUpdate\n                        class=\"form-input\"\n                        value=\"{{note.title}}\">\n                 </textarea>\n              <button type=\"button\" class=\"btn edit-button\"\n                      (click)=\"updateNote(noteUpdate.value, note)\"><i class=\"ion-edit\"></i>\n              </button>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
...
/* harmony import */ var _services_user_form_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../services/user-form.service */ "./src/app/services/user-form.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(fb, router, uf, usersService, loginService) {
        this.fb = fb;
        this.router = router;
        this.uf = uf;
    ...
    RegisterComponent.prototype.initForm = function () {
        ...
        this.registerForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({
            'username': new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](username, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required),
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"],
            ...
            _services_user_form_service__WEBPACK_IMPORTED_MODULE_7__["UserFormService"],
            _services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"],
            _services_login_service__WEBPACK_IMPORTED_MODULE_2__["LoginService"]])
    ], RegisterComponent);
...
module.exports = ".todos-component {\n  background-color: #ffffff;\n  padding: 2rem 0;\n  font-size: 1.5rem; }\n  .todos-component .todos--paragraph {\n    font-size: 1.6rem;\n    text-align: center;\n    padding: 2rem;\n    color: #212121;\n    letter-spacing: 1px; }\n  .todos-component .todos-content {\n    margin: 3rem auto;\n    width: 90%;\n    padding: 2rem; }\n  .todos-component .todos-content .todos-form {\n      width: 90%;\n      margin: 0 auto;\n      padding: 2rem; }\n  .todos-component .todos-content .todos-form div {\n        display: inline-block; }\n  .todos-component .todos-content .todos-form .from-to-value {\n        font-size: 1.4rem;\n        margin-right: 1rem;\n        margin-left: 1rem; }\n  .todos-component .todos-content .todos-form .from-to-value input {\n          width: 6rem; }\n  .todos-component .todos-content .todos-form .todo-input {\n        width: 70%;\n        margin-right: 3rem; }\n  @media (max-width: 37.5em) {\n          .todos-component .todos-content .todos-form .todo-input {\n            width: 90%; } }\n  @media (max-width: 37.5em) {\n        .todos-component .todos-content .todos-form .todo-button {\n          display: block;\n          text-align: center;\n          margin-top: 2rem; } }\n  .todos-component .todos-content .todos-form .form-input {\n        padding: 1.5rem 2rem;\n        color: inherit;\n        border-radius: 2px;\n        background-color: #f7f7f7;\n        border: none;\n        font-family: Lato, sans-serif;\n        border-bottom: 3px solid transparent;\n        width: 100%;\n        margin-left: 2rem;\n        display: block;\n        transition: all .3s; }\n  .todos-component .todos-content .todos-form .form-input:focus {\n          outline: none;\n          box-shadow: 0 1rem 2rem rgba(0, 0, 0, 0.1);\n          border-bottom: 3px solid #4776E6; }\n  .todos-component .todos-content .todos-form .form-input::-webkit-input-placeholder {\n          color: #212121; }\n  .todos-component .todos-content .todos-form .btn:hover {\n        color: #ffffff; }\n  .todos-component .todos-content .todos-container {\n      width: 90%;\n      margin: 0 auto; }\n  .todos-component .todos-content .todos-container button {\n        padding: 1rem 4rem;\n        margin-left: 3rem; }\n  .todos-component .todos-content .todos-container button:focus {\n          outline: none; }\n  .todos-component .todos-content .todos-container #todoEdit {\n        width: 50%; }\n  .todos-component .todos-content .todos-container #todoEdit:focus {\n          outline: none;\n          box-shadow: none; }\n  .todos-component .add-todolist-button {\n    margin-bottom: 2rem;\n    background-color: transparent;\n    background-image: linear-gradient(to right, rgba(111, 73, 231, 0.9), rgba(71, 118, 230, 0.9)); }\n  .jumbotron {\n  background-image: linear-gradient(to right bottom, rgba(111, 73, 231, 0.5), rgba(71, 118, 230, 0.5)), url('matteo-paganelli-39971-unsplash-min.jpg');\n  margin-bottom: 0;\n  background-size: cover;\n  background-attachment: fixed;\n  padding: 10rem 2rem; }\n  .jumbotron .heading-secondary {\n    color: #ffffff;\n    -webkit-transform: none;\n            transform: none;\n    width: 100%;\n    margin-top: 2rem; }\n  .todos__header--paragraph {\n  font-size: 1.8rem;\n  text-align: center;\n  text-transform: uppercase;\n  padding: 2rem 17rem 0;\n  color: #ffffff;\n  letter-spacing: 2px; }\n  .author {\n  font-size: 1.8rem;\n  text-align: center;\n  width: 100%;\n  text-transform: none;\n  color: #FFBD3A; }\n  .add_todo {\n  position: absolute;\n  right: 0;\n  margin-top: 0;\n  color: #4776E6;\n  cursor: pointer;\n  opacity: .7;\n  transition: all .2s ease-out; }\n  .add_todo:hover {\n    -webkit-transform: scale(1.3) rotate(90deg);\n            transform: scale(1.3) rotate(90deg);\n    opacity: 1; }\n  .add-todolist-form-container {\n  padding: 2rem;\n  position: relative; }\n  .add-todolist-form-container .form-input {\n    font-size: 1.5rem;\n    padding: 1.5rem 3.8rem;\n    color: inherit;\n    border-radius: 2px;\n    background-color: rgba(204, 204, 204, 0.1);\n    border: none;\n    font-family: Lato, sans-serif;\n    width: 100%;\n    display: block;\n    transition: all .3s;\n    border: 3px solid #6F49E7; }\n  .add-todolist-form-container .form-input:focus {\n      outline: none;\n      box-shadow: 0 1rem 2rem rgba(0, 0, 0, 0.1);\n      border: 3px solid transparent;\n      border-bottom: 3px solid #6F49E7; }\n  .add-todolist-form-container .form-input:focus:invalid {\n      border-bottom: 3px solid orangered !important; }\n  .add-todolist-form-container .form-input::-webkit-input-placeholder {\n      color: #212121; }\n  .add-todolist-form-container button:focus {\n    outline: none; }\n  .add-todolist-form {\n  margin-left: 2rem; }\n  .add-todolist-form input {\n    position: relative; }\n  .add-todolist-form p {\n    padding: 1rem;\n    margin-bottom: 1rem;\n    font-size: 1.4rem;\n    color: #757575; }\n  .add-todolist-form i {\n    position: absolute;\n    margin-left: 13px;\n    font-size: 1.7rem;\n    color: #cccccc;\n    margin-top: -35px; }\n  .todo-list {\n  padding: 1px;\n  margin-top: 1rem;\n  width: 47%;\n  display: -ms-inline-grid;\n  display: inline-grid;\n  margin-right: 2rem;\n  position: relative;\n  margin-bottom: 2rem; }\n  .todo-list .add_todo {\n    right: 5rem; }\n  .todo-list h3 {\n    text-transform: uppercase;\n    color: #212121;\n    display: inline;\n    margin-bottom: 1rem; }\n  .todo-list ul {\n    background-image: linear-gradient(to right bottom, rgba(111, 73, 231, 0.3), rgba(71, 118, 230, 0.3));\n    padding: 1rem;\n    border-radius: 5px;\n    list-style: none;\n    color: #000000; }\n  .todo-list ul li {\n      padding: 2rem;\n      position: relative; }\n  .todo-list ul li .todo-title {\n        margin-left: 3rem; }\n  .todo-list .checkbox {\n    display: none; }\n  .todo-list .form-checkbox {\n    height: 3rem;\n    width: 3rem;\n    border: 5px solid rgba(111, 73, 231, 0.7);\n    display: inline-block;\n    position: absolute;\n    left: 0;\n    top: -.4rem; }\n  .todo-list .form-checkbox::after {\n      content: \"\";\n      display: block;\n      height: 1.3rem;\n      width: 1.3rem;\n      position: absolute;\n      top: 50%;\n      left: 50%;\n      -webkit-transform: translate(-50%, -50%);\n      transform: translate(-50%, -50%);\n      background-color: rgba(111, 73, 231, 0.7);\n      opacity: 0;\n      transition: opacity .2s; }\n  .todo-list .checkbox-label {\n    font-size: 1.6rem;\n    cursor: pointer;\n    position: relative;\n    padding-left: 4.5rem; }\n  .todo-list .form-label {\n    font-size: 1.2rem;\n    font-weight: 700;\n    margin-left: 2rem;\n    margin-top: .7rem;\n    display: block;\n    transition: all .3s; }\n  .todo-list .checkbox:checked ~ .checkbox-label .form-checkbox::after {\n    opacity: 1; }\n  .todo-list .checked {\n    text-decoration: line-through;\n    color: #6F49E7;\n    opacity: .7; }\n  .todo-list .delete-icon {\n    position: absolute;\n    right: 0;\n    margin-top: 0;\n    color: #4776E6;\n    cursor: pointer;\n    opacity: .7;\n    transition: all .2s ease-out; }\n  .todo-list .delete-icon:hover {\n      -webkit-transform: scale(1.3) rotate(90deg);\n              transform: scale(1.3) rotate(90deg);\n      opacity: 1; }\n  .todo-list .todo--edit {\n    position: absolute;\n    right: 2rem;\n    margin-top: 0;\n    color: #4776E6;\n    cursor: pointer;\n    opacity: .7;\n    transition: all .2s ease-out; }\n  .todo-list .todo--edit:hover {\n      -webkit-transform: scale(1.3) rotate(90deg);\n              transform: scale(1.3) rotate(90deg);\n      opacity: 1; }\n  .edit-todo-list-form {\n  position: absolute;\n  top: -13px;\n  left: 0px;\n  background-color: #ffffff; }\n  .edit-todo-list-form input {\n    padding: 1rem;\n    outline: none;\n    border: none;\n    border-bottom: 3px solid #ff7730; }\n  .edit-todo-list-form button {\n    padding: .5rem 1rem;\n    margin-left: 2rem;\n    font-size: 1.3rem; }\n  .form-todo {\n  top: -3px;\n  left: 0px;\n  width: 100%; }\n  .form-todo input {\n    width: 77%; }\n  .close-popup {\n  position: absolute;\n  top: .5rem;\n  right: 0;\n  color: #6F49E7;\n  font-size: 1.5rem;\n  margin-right: 1rem;\n  padding: .2rem .7rem;\n  -webkit-transform: rotate(0deg);\n          transform: rotate(0deg);\n  transition: all ease-out .2s;\n  cursor: pointer; }\n  .close-popup:hover {\n    -webkit-transform: scale(1.3) rotate(90deg);\n            transform: scale(1.3) rotate(90deg); }\n  .todo-icon {\n  position: absolute;\n  left: -10rem;\n  top: 5%;\n  color: #ffffff;\n  background-color: #6F49E7;\n  border-radius: 50%;\n  font-size: 6rem;\n  padding: 1rem 4rem;\n  border: 10px solid rgba(204, 204, 204, 0.5); }\n  .todo-icon--todo {\n  padding: 1rem 2.5rem; }\n  .add-todolist-icon {\n  color: #6F49E7;\n  background-color: #fff;\n  border-radius: 50%;\n  font-size: 1.5rem;\n  margin-right: 1rem;\n  padding: .2rem .7rem; }\n  .modal-content {\n  border: none;\n  letter-spacing: 1px; }\n  .modal-header {\n  border-bottom: none; }\n  .modal-header h4 {\n    padding: 1rem 4rem;\n    font-size: 2.5rem;\n    color: #6F49E7; }\n  .modal-footer button {\n  background-color: #6F49E7; }\n  .modal-footer button::after {\n    background: #6F49E7; }\n  .modal-footer button:hover {\n    color: #ffffff; }\n"
